...
//Qestion 01
var invitationForGuest = ['rim', 'mishooo', 'rehan', 'zobia', 'fadi', 'rohit', 'zahid', 'saim', 'qasim', 'wajid', 'warda', 'kulsoom', 'tahir', 'laiba', 'bano', 'hanain', 'ubaid', 'rohi', 'emaan'];
console.log("great news! I found a bigger dinner table");
invitationForGuest.forEach(function (invitationForGuest) {
...
while (invitationForGuest.length > 2) {
    var removedGuest = invitationForGuest.pop();
...
//Qestion 03
var place = ['saudia', 'india', 'turki', 'usa', 'china'];
